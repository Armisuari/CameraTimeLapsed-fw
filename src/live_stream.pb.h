...
#ifndef PB_OPEN_GOPRO_SRC_LIVE_STREAM_PB_H_INCLUDED
#define PB_OPEN_GOPRO_SRC_LIVE_STREAM_PB_H_INCLUDED
#include <pb.h>
...
typedef struct _open_gopro_RequestSetLiveStreamMode {
    pb_callback_t url; /* RTMP(S) URL used for live stream */
    bool has_encode;
...
#define open_gopro_NotifyLiveStreamStatus_init_default {false, _open_gopro_EnumLiveStreamStatus_MIN, false, _open_gopro_EnumLiveStreamError_MIN, false, 0, false, 0, {{NULL}, NULL}, false, 0, false, 0, false, 0, false, 0, false, 0, {{NULL}, NULL}}
#define open_gopro_RequestGetLiveStreamStatus_init_default {{{NULL}, NULL}, {{NULL}, NULL}}
#define open_gopro_RequestSetLiveStreamMode_init_default {{{NULL}, NULL}, false, 0, false, _open_gopro_EnumWindowSize_MIN, {{NULL}, NULL}, false, 0, false, 0, false, 0, false, _open_gopro_EnumLens_MIN}
#define open_gopro_NotifyLiveStreamStatus_init_zero {false, _open_gopro_EnumLiveStreamStatus_MIN, false, _open_gopro_EnumLiveStreamError_MIN, false, 0, false, 0, {{NULL}, NULL}, false, 0, false, 0, false, 0, false, 0, false, 0, {{NULL}, NULL}}
#define open_gopro_RequestGetLiveStreamStatus_init_zero {{{NULL}, NULL}, {{NULL}, NULL}}
#define open_gopro_RequestSetLiveStreamMode_init_zero {{{NULL}, NULL}, false, 0, false, _open_gopro_EnumWindowSize_MIN, {{NULL}, NULL}, false, 0, false, 0, false, 0, false, _open_gopro_EnumLens_MIN}
